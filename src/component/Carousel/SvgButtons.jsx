function SvgButtons({ controlBtnClass, closeModal  }) {
    return(
        <div className="absolute top-4 right-4 z-[60] flex items-center gap-2">
            <button onClick={closeModal} className={controlBtnClass} title="Close">
...
//  <button onClick={handleToggleMute} className={controlBtnClass} title={isMuted ? "Unmute" : "Mute"}>
//               {isMuted ? (
